      ...
      >
        <div className="px-6 py-4 border-b flex items-center justify-between" style={{ borderColor: 'var(--divider)' }}>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold font-serif">{postcard.spotName} · 双人手帐明信片</h2>
          </div>
        ...
        <div className="p-6 space-y-4">
          ...
          >
            <div>
              ...
              {!isFlipped ? (
                ...
                <div className="space-y-3 text-xs" style={{ color: 'var(--text-sub)' }}>
                  <div className="flex items-start gap-2">
                    <Users className="w-4 h-4 shrink-0 mt-0.5" />
                    <div>
                      <span className="font-semibold">共同遇到的路人与插曲：</span>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <span className="font-semibold">画面视觉风格：</span>
            ...
            <div className="pt-3 border-t flex items-center justify-between text-xs opacity-70" style={{ borderColor: 'var(--divider)', color: 'var(--text-muted)' }}>
          ...
          {postcard.giftItem && (
            <div className="p-4 rounded-2xl border flex items-center gap-3" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--card-border)' }}>
              <div className="p-2 rounded-xl border" style={{ backgroundColor: 'var(--control-soft-bg)', borderColor: 'var(--card-border)' }}>
                <Gift className="w-5 h-5 text-amber-500" />
              </div>
              <div>
                <div className="text-xs font-bold" style={{ color: 'var(--text-main)' }}>同游搜集到的伴手礼</div>
                <div className="text-xs opacity-80" style={{ color: 'var(--text-sub)' }}>{postcard.giftItem}</div>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-between p-4 border-t" style={{ borderColor: 'var(--divider)' }}>
          <button
            ...
            className="px-4 py-2 rounded-xl text-xs font-semibold hover:opacity-80 flex items-center gap-1.5"
          ...
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-xl text-xs font-bold shadow-sm"
